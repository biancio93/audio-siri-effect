...
let siriWave_1 = new SiriWave({
  ...
  function preload() {
    let sound = loadSound('./audio/audio-test.mp3');
      let sound_2 = loadSound('./audio/audio-test.mp3');
      let sound_3 = loadSound('./audio/audio-test.mp3');
  }
  ...
  function setup() {
    ...
    let sound_2;
    let sound_3;
    let ele = createAudio('./audio/audio-test.mp3');
    ele.autoplay(false);
    ele.parent("test-1");
    ele.showControls();
    ele.connect(sound);
    ...
    let aud = document.querySelector(".audio-controller");
    console.log(aud);
    ...
    /* secondo elemento */
    let ele_2 = createAudio('./audio/audio-test.mp3');
    ...
    let aud_2 = document.querySelector(".audio-controller-2");
    aud_2.addEventListener("play", audioPlay_2);
    aud_2.addEventListener("pause", audioStop_2);
    aud_2.addEventListener("ended", audioStop_2);
    let amplitude_2 = new p5.Amplitude();
    /* terzo elemento */
    let ele_3 = createAudio('./audio/audio-test.mp3');
